...
*  **Controle de Consumo (`Lista Encadeada Simples`):** Estrutura que cruza os dados, permitindo controlar quem consumiu o que, baseado no valor de compra e na baixa do estoque, calculando o lucro final da Atlética.
